...
module.exports = function apiRoutes() {
    ...
    // ## Members
    router.get('/members', shared.middlewares.labs.members, apiv2.http(apiv2.members.browse));
    router.get('/members/:id', shared.middlewares.labs.members, apiv2.http(apiv2.members.read));
