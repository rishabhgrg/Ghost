...
module.exports = function setupParentApp(options = {}) {
    ...
    parentApp.use(urlUtils.getApiPath({version: 'active'}), require('./api/v2/content/app')());
    parentApp.use(urlUtils.getApiPath({version: 'active', admin: true}), require('./api/v2/admin/app')());
